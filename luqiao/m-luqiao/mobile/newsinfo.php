	...
	<div class="newsinfo">
		...
		<div class="info-content">
			<div class="details-head">
				<h3>简阳华冶路桥工程有限公司</h3>
				<p>作者：<span>简阳华冶路桥工程有限公司</span></p>
				<p>日期：<span>2017.05.31</span></p>
			</div>
			<div class="details">
				<p>简阳华冶路桥工程有限公司座落于成都市简阳市太平桥镇318国道边，距成都第二绕城高速出口1公里，距成都35公里，高速直达，交通便利。以四川为中心，西南.西北和华中市场同步发展，打造中国西南地区最专业的装配式公路钢桥行业领导品牌。</p>
				<img src="<?php echo static_file('mobile/img/newsinfo.jpg'); ?>" alt="新闻详情">
			...
			<div class="details-tail">
				...
				<div class="tail-btn"><button><a href="<?php echo site_url('news'); ?>">返回列表</a></button></div>
			</div>
		</div>
	</div>

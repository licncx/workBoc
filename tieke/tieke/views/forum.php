...
<body>
	...
	<div class="news">
		<div class="news-content">
			...
			<div class="content-lt">
				<div class="left-nav">
					<ul>
						<li class="menuHead"><a>员工论坛</a></li>
						<li><a href="<?php echo site_url('forum'); ?>"><span>&#xe600;</span>员工论坛</a></li>
						<li><a href=""><span>&#xe600;</span>热点专题</a></li>
						<li><a href=""><span>&#xe600;</span>科研动态</a></li>
						<li><a href=""><span>&#xe600;</span>读书学习</a></li>
						<li>
							<a href="javascript:void(0)"><span>&#xe600;</span>文学园地</a>
							<ol>
								<li><a href=""><span>&#xe600;</span>文学创作</a></li>
								<li><a href=""><span>&#xe600;</span>摄影作品</a></li>
							</ol>
						</li>
					</ul>
				</div>
			...
			<div class="content-rt">
				<div class="rt-box">
					<h3>员工论坛</h3>
					<div class="item">
						<a href="<?php echo site_url('foruminfo'); ?>">
	...
	<script>
		$(".header").find('.nav').find('ul>li>a').eq(8).css('background','#b90000')

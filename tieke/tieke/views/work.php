...
<body>
	...
	<div class="intro">
		<div class="intro-content">
			...
			<div class="content-lt">
				<div class="left-nav">
					<ul>
						<li class="menuHead"><a>党群工作</a></li>
						<li><a href="<?php echo site_url('work'); ?>"><span>&#xe600;</span>党建工作</a></li>
						<li><a href=""><span>&#xe600;</span>两学一做</a></li>
						<li><a href=""><span>&#xe600;</span>纪检监察</a></li>
						<li><a href=""><span>&#xe600;</span>工会工作</a></li>
						<li><a href=""><span>&#xe600;</span>职工之家</a></li>
						<li><a href=""><span>&#xe600;</span>青年园地</a></li>
						<li><a href=""><span>&#xe600;</span>党建主题活动</a></li>
					</ul>
				</div>
			</div>
	...
	<script>
		$(".header").find('.nav').find('ul>li>a').eq(6).css('background','#b90000')

...
<body>
	...
	<div class="intro">
		<div class="location">
			...
			<a href="<?php echo site_url('intro'); ?>">公司简介</a>
		</div>
		<div class="content">
			<h3>公司简介</h3>
			<b></b>
			...
			<p>四川铁科建设监理有限公司主营业务：铁路工程、公路工程、隧道及地下工程、桥梁结构工程、水利电力工程、机电工程及其相关工程的建设监理业务，兼营铁道及相关工程的技术咨询、项目管理、施工监测等业务。1997年5月，被建设部批准为甲级监理资质单位；2001年2月获铁道部颁发建设监理许可证；2009年11月，经国家核定资质范围为：铁路工程（甲级）、市政公用工程（甲级）、公路工程（甲级）、房屋建筑工程（甲级）、机电安装工程（乙级）；2015年5月获得人防工程监理乙级资质。</p>
